...
const Learning = () => {
  return (
    <div className='bg-[url("/src/assets/img/heroman.jpg")] min-h-[90vh] bg-cover bg-center flex flex-col justify-center items-center text-white'>
        ...
        <button className="w-[40%]  md:block mx-auto my-[1rem] rounded-md text-white font-bold py-[0.5rem] bg-[#2ECBF1] hover:bg-[#2ECBF1] hover:text-[#030C4B] hover:scale-[1.1] "><Link to='/mentorship'>Register for the next class now </Link></button>
    </div>
  )
}
